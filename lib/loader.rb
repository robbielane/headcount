...
class Loader
  ...
  def self.load_high_school_graduation_rates
    ...
    map_csv_omit_zeros(graduation_rates)
  end
  ...
  def self.load_proficient_grade_three
    ...
    map_csv_omit_zeros(grade_three_prof)
  end
  ...
  def self.load_proficient_grade_eight
    ...
    map_csv_omit_zeros(grade_eight_prof)
  end
  ...
  def self.load_average_math_prof_by_race
    ...
    map_csv_omit_zeros(average_prof_by_race_math)
  end
  ...
  def self.load_average_reading_prof_by_race
    ...
    map_csv_omit_zeros(average_prof_by_race_reading)
  end
  ...
  def self.load_students_reduced_priced_lunch
    ...
    map_csv_omit_zeros(reduced_price_lunch)
  end

  def self.load_title_one_students
    title_one_students = "./data/Title I students.csv"
    map_csv_omit_zeros(title_one_students)
  end

  def self.map_csv_omit_zeros(file)
